...
public class ImportResultList {
	...
	private Map<Integer, Map<Integer, String[]>> errorMapList = new HashMap<Integer, Map<Integer,String[]>>();
	...
	public Map<Integer, Map<Integer, String[]>> getErrorMapList() {
		return errorMapList;
	}

	public void setErrorMapList( Map<Integer, Map<Integer, String[]>> errorMapList ) {
