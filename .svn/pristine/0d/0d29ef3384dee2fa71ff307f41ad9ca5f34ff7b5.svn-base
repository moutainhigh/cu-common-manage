...
public class UploadFileXsdValidator {
	...
	private static Logger logger = Logger.getLogger(UploadFileXsdValidator.class);
	 ...
	 * @throws Exception
	 */
	public String doValidate(int type, java.io.InputStream inputStream) throws Exception {
		String xsdName = "";
		switch (type) {
