...
import com.aotain.common.utils.model.push.CommandPushDetail;
...
import com.aotain.common.utils.model.push.PushParam;
import com.aotain.common.utils.model.push.PushReceiver;
import com.aotain.common.utils.model.push.PushResponse;
import com.aotain.common.utils.model.push.SMSPushMessageRecord;
...
public class PushClient {
	...
	private Logger logger = Logger.getLogger(PushClient.class);
		...
		for (Integer pType : types) {
			...
			try {
				...
				try {
					...
					MonitorStatisticsUtils.addEvent(ModuleConstant.MODULE_MESSAGE_COMMON, e);
				}
			} catch (Exception e) {
				logger.error("推送请求发送失败", e);
				MonitorStatisticsUtils.addEvent(ModuleConstant.MODULE_MESSAGE_COMMON, e);
