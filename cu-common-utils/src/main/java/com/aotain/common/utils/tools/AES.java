...
public class AES {
	...
	// 加密
	public static String Encrypt(byte[] src, String sKey, String sIv)
			throws Exception {
		if (sKey == null) {
			System.out.print("Key为空null");
			return null;
	...
	// 解密
	public static byte[] DecryptReturnByte(String sSrc, String sKey, String sIv)
			throws Exception {
		try {
			// 判断Key是否正确
			if (sKey == null) {
	...
	// 解密
	public static String DecryptAESAndMD5(String sSrc, String sKey, String sIv)
			throws Exception {
		try {
			// 判断Key是否正确
			if (sKey == null) {
