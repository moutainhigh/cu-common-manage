...
import com.aotain.cu.serviceapi.dto.UserFrameInformationDTO;
...
public class UserInformation extends BaseModel implements Serializable {
	...
	@Transient
	/**
	 * 用户录入时，是否存在相同用户信息(id idType name)
	 * true--存在  false--不存在
	 * */
	private boolean coverUser;
    ...
    private List<HouseUserFrameInformation> userFrame;
	...
	public boolean getCoverUser() {
		return coverUser;
	}

	public void setCoverUser(boolean coverUser) {
	...
	public List<HouseUserFrameInformation> getUserFrame() {
		return userFrame;
	}

	public void setUserFrame( List<HouseUserFrameInformation> userFrame ) {
